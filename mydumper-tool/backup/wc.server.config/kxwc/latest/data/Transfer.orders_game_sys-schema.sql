...
CREATE TABLE `orders_game_sys` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `curMoney` bigint(20) DEFAULT '0',
  `money` bigint(20) DEFAULT NULL COMMENT '订单帐变金额',
  `afterMoney` bigint(20) DEFAULT '0',
  `status` int(11) DEFAULT NULL COMMENT '订单状态0处理中 1 是成功，2是失败',
  `type` int(11) DEFAULT NULL COMMENT '订单类型0玩家上分1玩家下分',
