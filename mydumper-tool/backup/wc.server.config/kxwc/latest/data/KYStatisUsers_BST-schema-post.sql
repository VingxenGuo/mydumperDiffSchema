...
CREATE DEFINER=`root`@`%` EVENT `event_StatisUsersDayData_BST_08:30` ON SCHEDULE EVERY 1 DAY STARTS '2023-01-17 08:30:00' ON COMPLETION NOT PRESERVE ENABLE DO call `KYStatisUsers_BST`.`sp_StatisUsersDayData`(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
