...
CREATE TABLE `statis_record_agent_game` (
  ...
  KEY `IDX_SC` (`StatisDate`,`ChannelID`) USING BTREE,
  KEY `IDX_SD` (`StatisDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
/*!50100 PARTITION BY RANGE ( TO_DAYS(`StatisDate`))
(PARTITION p_202303 VALUES LESS THAN (738945) ENGINE = InnoDB,
 PARTITION p_202304 VALUES LESS THAN (738976) ENGINE = InnoDB,
