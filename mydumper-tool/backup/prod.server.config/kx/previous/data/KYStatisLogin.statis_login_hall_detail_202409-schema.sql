...
CREATE TABLE `statis_login_hall_detail_202409` (
  ...
  KEY `statis_login_hall_detail_202409_Accounts_IDX` (`Accounts`) USING BTREE,
  KEY `statis_login_hall_detail_202409_StatisDate_IDX` (`StatisDate`) USING BTREE
