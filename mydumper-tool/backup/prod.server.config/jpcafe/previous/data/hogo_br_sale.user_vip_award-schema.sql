...
CREATE TABLE `user_vip_award` (
  ...
  `oid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单号',
  `batch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '批次',
  `consume` bigint NOT NULL DEFAULT '0' COMMENT '下注金额',
