...
CREATE TABLE `brokerage_date` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '获得佣金玩家ID',
  ...
  `brokerage` bigint DEFAULT NULL COMMENT '當日佣金加總',
