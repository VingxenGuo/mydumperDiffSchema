...
CREATE TABLE `bank_attributes` (
  ...
  `bank_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '銀行ID',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `bank_id_key_unique` (`bank_id`,`key`),
  CONSTRAINT `bank_attributes_bank_id_foreign` FOREIGN KEY (`bank_id`) REFERENCES `banks` (`id`) ON DELETE CASCADE
