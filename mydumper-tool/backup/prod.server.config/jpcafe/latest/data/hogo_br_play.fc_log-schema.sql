...
CREATE TABLE `fc_log` (
  ...
  `Bet` bigint NOT NULL DEFAULT '0' COMMENT '押注金额',
  `Win` bigint NOT NULL DEFAULT '0' COMMENT '游戏赢分',
  `JPBet` bigint NOT NULL DEFAULT '0' COMMENT '彩金押注金额',
  `JPPrize` bigint NOT NULL DEFAULT '0' COMMENT '彩金赢分',
  `NetWin` bigint NOT NULL DEFAULT '0' COMMENT '总输赢',
  `RequireAmt` bigint NOT NULL DEFAULT '0' COMMENT '实际押注金额(仅推币机与捕鱼机)',
