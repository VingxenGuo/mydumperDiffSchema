...
SET character_set_results = utf8mb4;
SET collation_connection = utf8mb4_general_ci;
DROP PROCEDURE IF EXISTS `sp_normalPlayerOrderDetail_for_DBA_test`;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_normalPlayerOrderDetail_for_DBA_test`(IN pPlayerAccount VARCHAR(200)
