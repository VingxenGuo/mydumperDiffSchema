...
SET v_spENDtime = CURRENT_TIMESTAMP(); 
	...
	-- 添加执行日志
INSERT INTO KYStatisUsers.event_log_record (sp_name, starttime, ENDtime, exectime,mark) VALUES ('KYStatisUsers.sp_StatisUsersDayData', v_spStartTime, v_spENDtime, TIMESTAMPDIFF(SECOND,v_spStartTime,v_spENDtime),in_StatisDate); 
END;
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
...
BEGIN
	...
	INSERT INTO KYStatisUsers.event_log_record (sp_name, starttime, endtime, exectime,mark) VALUES ('KYStatisUsers.sp_StatisUsersDayData_allusers', v_starttime, v_endtime, TIMESTAMPDIFF(SECOND,v_starttime,v_endtime),in_StatisDate); 
END;
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
...
BEGIN
	...
	-- 添加执行日志
	INSERT INTO KYStatisUsers.event_log_record (sp_name, starttime, endtime, exectime,mark) VALUES ('KYStatisUsers.sp_StatisUsersDayData_room', v_starttime, v_endtime, TIMESTAMPDIFF(SECOND,v_starttime,v_endtime),in_StatisDate); 
END;
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
