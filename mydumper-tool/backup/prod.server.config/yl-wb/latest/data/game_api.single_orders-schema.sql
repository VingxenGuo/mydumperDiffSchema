...
CREATE TABLE `single_orders` (
  ...
  `account` varchar(190) COLLATE utf8mb4_bin NOT NULL COMMENT '玩家账号',
...
(PARTITION p_202307 VALUES LESS THAN (1688140800) ENGINE = InnoDB,
 PARTITION p_202308 VALUES LESS THAN (1690819200) ENGINE = InnoDB,
 PARTITION p_202309 VALUES LESS THAN (1693497600) ENGINE = InnoDB,
