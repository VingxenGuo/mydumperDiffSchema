...
CREATE DEFINER=`root`@`%` EVENT `event_StatisUsersDayData` ON SCHEDULE EVERY 1 DAY STARTS '2023-06-01 13:30:00' ON COMPLETION NOT PRESERVE DISABLE ON SLAVE DO call sp_StatisUsersDayData(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
