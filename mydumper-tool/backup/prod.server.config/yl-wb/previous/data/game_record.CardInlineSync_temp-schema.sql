...
CREATE TABLE `CardInlineSync_temp` (
  `big_dataId` bigint(20) NOT NULL DEFAULT '0',
  `GameName` varchar(14) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `GameID` int(11) NOT NULL DEFAULT '0',
  `GameNo` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `AllBet` float DEFAULT NULL,
  `CellScore` float DEFAULT NULL,
  ...
  `Account` varchar(190) CHARACTER SET utf8 DEFAULT NULL COMMENT '玩家账号',
  `WinMoney` float DEFAULT NULL,
  `Revenue` float DEFAULT NULL,
  `Profit` float NOT NULL DEFAULT '0',
  `OrderSyncExist` varchar(1) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'Y'
