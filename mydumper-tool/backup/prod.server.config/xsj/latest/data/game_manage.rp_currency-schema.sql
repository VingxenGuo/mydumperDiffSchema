...
CREATE TABLE `rp_currency` (
  ...
  `isAgent` tinyint(1) NOT NULL DEFAULT '0' COMMENT '代理交收是否可以使用该币别',
  `isPlayer` tinyint(1) NOT NULL DEFAULT '0' COMMENT '会员钱包是否可以使用该币别',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '币别是否启用',
