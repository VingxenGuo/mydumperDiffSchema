...
SET character_set_results = utf8mb4;
SET collation_connection = utf8mb4_general_ci;
DROP PROCEDURE IF EXISTS `sp_StatisUsersByDayWithoutAcc`;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_StatisUsersByDayWithoutAcc`(
...
CREATE DEFINER=`root`@`%` EVENT `event_00_20_sp_StatisUsersDayData` ON SCHEDULE EVERY 1 DAY STARTS '2021-06-21 00:20:00' ON COMPLETION NOT PRESERVE ENABLE DO call KYStatisUsers.sp_StatisUsersDayData(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
SET @PREV_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT;
...
CREATE DEFINER=`root`@`%` EVENT `event_01_20_sp_StatisUsersDayData_allusers` ON SCHEDULE EVERY 1 DAY STARTS '2021-06-22 03:20:00' ON COMPLETION NOT PRESERVE ENABLE DO call KYStatisUsers.sp_StatisUsersDayData_allusers(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
SET @PREV_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT;
...
CREATE DEFINER=`root`@`%` EVENT `event_06_30_sp_StatisUsersDayData_room` ON SCHEDULE EVERY 1 DAY STARTS '2021-06-22 06:30:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL KYStatisUsers.sp_StatisUsersDayData_room (NULL);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
SET @PREV_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT;
...
CREATE DEFINER=`root`@`%` EVENT `event_sp_StatisUsersData_EveryDay` ON SCHEDULE EVERY 1 DAY STARTS '2021-09-08 02:30:00' ON COMPLETION NOT PRESERVE ENABLE DO call sp_StatisUsersData_EveryDay(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
SET @PREV_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT;
...
CREATE DEFINER=`root`@`%` EVENT `event_sp_UpdateDayrecordVvipUsers_00:30` ON SCHEDULE EVERY 1 DAY STARTS '2023-01-01 00:30:00' ON COMPLETION NOT PRESERVE ENABLE DO call `KYStatisUsers`.`sp_UpdateDayrecordVvipUsers`(null);
SET character_set_client = @PREV_CHARACTER_SET_CLIENT;
SET character_set_results = @PREV_CHARACTER_SET_RESULTS;
SET collation_connection = @PREV_COLLATION_CONNECTION;
