...
CREATE TABLE `statis_room_monitoring` (
  ...
  `killGameNum` bigint(20) DEFAULT NULL,
  `diveGameNum` bigint(20) DEFAULT NULL,
  `normalValidbet` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_createdate` (`createdate`),
  KEY `index_createdate_roomId` (`createdate`,`roomId`,`gameId`) USING BTREE
